...
$tap1Name = 'tap102i1' # Modify as needed based on VM ID
$tap2Name = 'tap102i2' # Modify as needed based on VM ID
$span0Name = 'selksCyberRange'
$span1Name = 'selksProd'
$mirrorStats = ovs-vsctl --format=csv list mirror | ConvertFrom-Csv | Where-Object name -like 'secOnion*'
